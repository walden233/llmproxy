...
//    @Rollback(value = false)
    ...
    void testRegisterAdmin_UsernameAlreadyExists() throws Exception {
        // 先注册一个用户
        UserRegisterRequest initialRequest = new UserRegisterRequest();
    ...
    void testLoginAdmin_Success() throws Exception {
        ...
        Result<UserLoginResponse> loginResult = objectMapper.readValue(responseString, new TypeReference<Result<UserLoginResponse>>() {});
