    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        // 1. 公开访问的端点
                        .requestMatchers("/v1/auth/login", "/v1/auth/register", "/v1/chat","/v2/chat","/v2/chat/stream", "/v1/generate-image","v1/async/chat","v1/async/generate-image",
                                "/v1/conversations/**").permitAll()
